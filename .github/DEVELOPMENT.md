...
```shell
git clone https://github.com/<your-name-here>/feishubot
cd feishubot
pnpm install
```
...
Note that [console-fail-test](https://github.com/WumaCoder/console-fail-test) is enabled for all test runs.
...
```shell
node ../feishubot/lib/hydrate/index.js -- description "Hooray, trying things out locally."
```
